...
namespace osu.Framework.Live2D.Tests.Visual
{
    ...
    public class TestSceneMotionQueue : TestSceneBase
    {
        ...
        private void load()
        {
            ...
            AddStep("enqueue motion", () => Sprite.StartMotion("", 0, MotionType.Base));
            ...
            AddRepeatStep("enqueue motions", () => Sprite.StartMotion("", 0, MotionType.Base), 5);
            ...
            AddRepeatStep("enqueue motions", () => Sprite.StartMotion("", 0, MotionType.Base), 5);
            AddStep("enqueue forced motion", () => Sprite.StartMotion("", 1, MotionType.Base, true));
            AddAssert("check queue if empty", () => Sprite.BaseMotionsQueued == 0);

            AddLabel("Looping Motion");
            AddStep("enqueue looping motion", () => Sprite.StartMotion("", 2, MotionType.Base, true, true));
            AddWaitStep("wait", 30);
            AddAssert("check motion", () => Sprite.IsMoving);
