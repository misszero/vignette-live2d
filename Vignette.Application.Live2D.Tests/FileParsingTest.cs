...
using Vignette.Application.Live2D.Motion.Physics;
...
namespace Vignette.Application.Live2D.Tests
{
    ...
    public class FileParsingTest
    {
        ...
        public void TestMotionFileParsing()
        {
            ...
            var motion = new CubismMotion(loadJsonFile<CubismMotionSetting>(motionFile), model, setting.FileReferences.Motions["Idle"][0]);
        ...
        {
            var physics = new CubismPhysics(loadJsonFile<CubismPhysicsSetting>(@"Hiyori.physics3.json"), model);
